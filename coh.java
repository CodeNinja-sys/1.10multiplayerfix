...
public class coh
extends axg {
    public abd[] a = new abd[7];

    public coh() {
        this.a[0] = new abd(this, 0, 10);
        this.a[1] = new abd(this, 0, 0);
        this.a[2] = new abd(this, 0, 0);
        this.a[3] = new abd(this, 0, 0);
        this.a[4] = new abd(this, 0, 0);
        this.a[5] = new abd(this, 44, 10);
        int n2 = 20;
        int n3 = 8;
        int n4 = 16;
        int n5 = 4;
