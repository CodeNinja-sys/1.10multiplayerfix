...
public class q {
    ...
    public static void a(byte[] arrby, long l2, OutputStream outputStream, int n2) {
        ...
        for (int i2 = n2; i2 < arrby.length; i2 += 16) {
            ...
            q.a(stringBuilder, l3).append(' ');
            for (n3 = 0; n3 < 16; ++n3) {
                if (n3 < n4) {
                    q.a(stringBuilder, arrby[n3 + i2]);
                } else {
            ...
            for (n3 = 0; n3 < n4; ++n3) {
                if (arrby[n3 + i2] >= 32 && arrby[n3 + i2] < 127) {
                    stringBuilder.append((char)arrby[n3 + i2]);
                    continue;
                }
                stringBuilder.append('.');
            }
    ...
    private static StringBuilder a(StringBuilder stringBuilder, long l2) {
        for (int i2 = 0; i2 < 8; ++i2) {
            stringBuilder.append(b[(int)(l2 >> c[i2]) & 0xF]);
        }
    ...
    private static StringBuilder a(StringBuilder stringBuilder, byte by2) {
        for (int i2 = 0; i2 < 2; ++i2) {
            stringBuilder.append(b[by2 >> c[i2 + 6] & 0xF]);
        }
        return stringBuilder;
    }
}
