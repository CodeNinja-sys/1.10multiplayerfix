...
extends bc {
    private q(String[] arrstring) {
        super("ExtendedThrowable", "throwable", arrstring);
    }

    public static q a(String[] arrstring) {
        return new q(arrstring);
    }
