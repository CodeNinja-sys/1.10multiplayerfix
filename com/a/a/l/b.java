...
RandomAccess {
    ...
    public boolean contains(Object object) {
        return object instanceof Boolean && com.a.a.l.a.a(this.a, (boolean)((Boolean)object), this.b, this.c) != -1;
    }

    @Override
    public int indexOf(Object object) {
        int n2;
        if (object instanceof Boolean && (n2 = com.a.a.l.a.a(this.a, (boolean)((Boolean)object), this.b, this.c)) >= 0) {
            return n2 - this.b;
        }
        return -1;
    }
    ...
    public int lastIndexOf(Object object) {
        int n2;
        if (object instanceof Boolean && (n2 = com.a.a.l.a.b(this.a, (boolean)((Boolean)object), this.b, this.c)) >= 0) {
            return n2 - this.b;
        }
        return -1;
    }
    ...
    public Boolean a(int n2, Boolean bl2) {
        ...
        this.a[this.b + n2] = (Boolean)cl.a(bl2);
        return bl3;
    }
    ...
    public int hashCode() {
        ...
        for (int i2 = this.b; i2 < this.c; ++i2) {
            n2 = 31 * n2 + com.a.a.l.a.a(this.a[i2]);
        }
        return n2;
    }
