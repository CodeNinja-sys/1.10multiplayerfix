...
class g {
    ...
    float[] b;
    int[] c;
    static int[] d = new int[]{4, 2, 3, 5};
    static float e = (float)Math.PI * 2;
    static float f = 0.70710677f;
    static float g = 0.8660254f;
    static float h = -0.5f;
    static float i = 1.4142135f;
    ...
    void a(float[] arrf) {
        ...
        com.b.b.g.a(this.a, arrf, this.b, this.b, this.a, this.c);
    }

    void a(int n2) {
        this.a = n2;
        this.b = new float[3 * n2];
        this.c = new int[32];
        com.b.b.g.a(n2, this.b, this.c);
    }
     ...
     */
    static void a(int n2, float[] arrf, int n3, int[] arrn) {
        int n4 = 0;
        int n5 = -1;
        int n6 = n2;
        int n7 = 0;
    ...
    static void a(int n2, float[] arrf, int[] arrn) {
        if (n2 == 1) {
            return;
        }
        com.b.b.g.a(n2, arrf, n2, arrn);
    }

    static void a(int n2, int n3, float[] arrf, float[] arrf2, float[] arrf3, int n4) {
        int n5;
        int n6;
        int n7 = 0;
        int n8 = n6 = n3 * n2;
    ...
    static void a(int n2, int n3, float[] arrf, float[] arrf2, float[] arrf3, int n4, float[] arrf4, int n5, float[] arrf5, int n6) {
        float f2;
        int n7;
        int n8;
        float f3;
        ...
        n7 = n2;
        for (n9 = 0; n9 < n3; ++n9) {
            f2 = -f * (arrf[n11] + arrf[n13]);
            f4 = f * (arrf[n11] - arrf[n13]);
    ...
    static void a(int var0, int var1_1, int var2_2, int var3_3, float[] var4_4, float[] var5_5, float[] var6_6, float[] var7_7, float[] var8_8, float[] var9_9, int var10_10) {
        ...
        var38_12 = 0.0f;
        var40_13 = 0.0f;
        var39_14 = com.b.b.g.e / (float)var1_1;
...
lbl153:
     ...
     * Enabled aggressive block sorting
     */
    static void a(int n2, float[] arrf, float[] arrf2, float[] arrf3, int[] arrn) {
        int n3 = arrn[1];
        int n4 = 1;
        int n5 = n2;
        int n6 = n2;
            ...
            block10: while (true) {
                switch (n14) {
                    case 100: {
                        ...
                        int n16 = n15 + n9;
                        if (n4 != 0) {
                            com.b.b.g.a(n9, n10, arrf2, arrf, arrf3, n6 - 1, arrf3, n15 - 1, arrf3, n16 - 1);
                        } else {
                            com.b.b.g.a(n9, n10, arrf, arrf2, arrf3, n6 - 1, arrf3, n15 - 1, arrf3, n16 - 1);
                        }
                        n14 = 110;
                        break;
                    }
                    case 102: {
                        ...
                        com.b.b.g.a(n9, n10, arrf, arrf2, arrf3, n6 - 1);
                        n14 = 110;
                        break;
                    }
                    case 103: {
                        com.b.b.g.a(n9, n10, arrf2, arrf, arrf3, n6 - 1);
                    }
                    case 104: {
                        if (n9 == 1) {
                            n4 = 1 - n4;
                        ...
                        com.b.b.g.a(n9, n11, n10, n8, arrf, arrf, arrf, arrf2, arrf2, arrf3, n6 - 1);
                        n4 = 1;
                        n14 = 110;
                        break;
                    }
                    case 109: {
                        com.b.b.g.a(n9, n11, n10, n8, arrf2, arrf2, arrf2, arrf, arrf, arrf3, n6 - 1);
                        n4 = 0;
                    }
                    case 110: {
                        n5 = n10;
    ...
    static void b(int n2, int n3, float[] arrf, float[] arrf2, float[] arrf3, int n4) {
        int n5;
        int n6 = n3 * n2;
        int n7 = 0;
        int n8 = 0;
    ...
    static void a(int n2, int n3, float[] arrf, float[] arrf2, float[] arrf3, int n4, float[] arrf4, int n5) {
        float f2;
        float f3;
        float f4;
        int n6;
        ...
        for (n6 = 0; n6 < n3; ++n6) {
            ...
            for (int i2 = 2; i2 < n2; i2 += 2) {
                ...
                f3 = arrf[(n13 += 2) - 1] + h * f4;
                arrf2[(n15 += 2) - 1] = arrf[n13 - 1] + f4;
                float f5 = arrf[n12] - arrf[n14];
                float f6 = arrf[n13] + h * f5;
                arrf2[n15] = arrf[n13] + f5;
                float f7 = g * (arrf[n12 - 1] - arrf[n14 - 1]);
                f2 = g * (arrf[n12] + arrf[n14]);
                float f8 = f3 - f2;
                float f9 = f3 + f2;
                float f10 = f6 + f7;
                float f11 = f6 - f7;
    ...
    static void b(int n2, int n3, float[] arrf, float[] arrf2, float[] arrf3, int n4, float[] arrf4, int n5, float[] arrf5, int n6) {
        float f2;
        float f3;
        float f4;
        float f5;
                ...
                block10: while (true) {
                    block0 : switch (var45_18) {
                        case 100: {
                            ...
                            var40_41 = com.b.b.g.e / (float)var1_1;
...
lbl152:
     ...
     * Enabled aggressive block sorting
     */
    static void a(int n2, float[] arrf, float[] arrf2, float[] arrf3, int n3, int[] arrn) {
        int n4 = 0;
        int n5 = 0;
        int n6 = 0;
        int n7 = 0;
            ...
            block9: while (true) {
                switch (n14) {
                    case 100: {
                        ...
                        int n16 = n15 + n6;
                        if (n9 != 0) {
                            com.b.b.g.b(n6, n10, arrf2, arrf, arrf3, n3 + n11 - 1, arrf3, n3 + n15 - 1, arrf3, n3 + n16 - 1);
                        } else {
                            com.b.b.g.b(n6, n10, arrf, arrf2, arrf3, n3 + n11 - 1, arrf3, n3 + n15 - 1, arrf3, n3 + n16 - 1);
                        }
                        n9 = 1 - n9;
                        n14 = 115;
                        break;
                    ...
                    case 103: {
                        ...
                        if (n9 != 0) {
                            com.b.b.g.b(n6, n10, arrf2, arrf, arrf3, n3 + n11 - 1);
                        } else {
                            com.b.b.g.b(n6, n10, arrf, arrf2, arrf3, n3 + n11 - 1);
                        }
                        n9 = 1 - n9;
                        n14 = 115;
                        break;
                    ...
                    case 106: {
                        ...
                        int n15 = n11 + n6;
                        if (n9 != 0) {
                            com.b.b.g.a(n6, n10, arrf2, arrf, arrf3, n3 + n11 - 1, arrf3, n3 + n15 - 1);
                        } else {
                            com.b.b.g.a(n6, n10, arrf, arrf2, arrf3, n3 + n11 - 1, arrf3, n3 + n15 - 1);
                        }
                        n9 = 1 - n9;
                        n14 = 115;
                        break;
                    ...
                    case 109: {
                        if (n9 != 0) {
                            com.b.b.g.b(n6, n5, n10, n7, arrf2, arrf2, arrf2, arrf, arrf, arrf3, n3 + n11 - 1);
                        } else {
                            com.b.b.g.b(n6, n5, n10, n7, arrf, arrf, arrf, arrf2, arrf2, arrf3, n3 + n11 - 1);
                        }
                        if (n6 == 1) {
                            n9 = 1 - n9;
                        }
