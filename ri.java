...
public class ri {
    ...
    private ri(String string, int n2) {
        this.a = string;
        this.b = n2;
    }
    ...
    public static ri a(String string) {
        int n2;
        Object object;
        int n3;
        if (string == null) {
        ...
        int n4 = n2 = arrstring.length > 1 ? ri.a(arrstring[1], 25565) : 25565;
        if (n2 == 25565) {
            object = ri.b(string3);
            string3 = object[0];
            n2 = ri.a(object[1], 25565);
        }
        return new ri(string3, n2);
    }
