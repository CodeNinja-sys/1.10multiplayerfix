...
extends oh {
    ...
    public int[] a(int n2, int n3, int n4, int n5) {
        ...
        for (int i2 = 0; i2 < n10 - 1; ++i2) {
            int n13 = arrn[n6 + 0 + (i2 + 0) * n9];
            int n14 = arrn[n6 + 0 + (i2 + 1) * n9];
            for (n6 = 0; n6 < n9 - 1; ++n6) {
                double d2 = 3.6;
                ...
                int n15 = arrn[n6 + 1 + (i2 + 0) * n9] & 0xFF;
                int n16 = arrn[n6 + 1 + (i2 + 1) * n9] & 0xFF;
                for (int i3 = 0; i3 < 4; ++i3) {
                    ...
                    for (int i4 = 0; i4 < 4; ++i4) {
                        ...
                        arrn2[n17++] = d11 < d12 && d11 < d13 && d11 < d14 ? n13 : (d12 < d11 && d12 < d13 && d12 < d14 ? n15 : (d13 < d11 && d13 < d12 && d13 < d14 ? n14 : n16));
                    }
                }
                n13 = n15;
                n14 = n16;
        ...
        for (n6 = 0; n6 < n5; ++n6) {
            System.arraycopy(arrn2, (n6 + (n3 & 3)) * n11 + (n2 & 3), arrn3, n6 * n4, n4);
        }
        return arrn3;
    }
}
