...
public class aig {
    ...
    public DataOutputStream b(int n2, int n3) {
        ...
        return new DataOutputStream(new BufferedOutputStream(new DeflaterOutputStream(new bda(this, n2, n3))));
    }
    ...
    protected synchronized void a(int n2, int n3, byte[] arrby, int n4) {
        try {
            ...
            this.b(n2, n3, (int)(net.minecraft.c.a.av() / 1000L));
        }
        catch (IOException iOException) {
            iOException.printStackTrace();
        }
