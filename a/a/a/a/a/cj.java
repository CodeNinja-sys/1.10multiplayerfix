...
implements Callable {
    ...
    cj(AtomicInteger atomicInteger, int n2, LinkedBlockingQueue linkedBlockingQueue, int[] arrn, int[] arrn2, boolean bl2, int[] arrn3) {
    ...
    public Void a() {
        ...
        while (true) {
            ...
            int n9 = n4 + n5;
            while (n9-- != n4) {
                int n10 = this.d[this.e[n9]] >>> n8 & 0xFF ^ n7;
                arrn[n10] = arrn[n10] + 1;
            }
            n9 = -1;
            int n11 = n4;
            ...
            if (this.f) {
                n2 = n4 + n5;
                while (n2-- != n4) {
                    int n12 = this.d[this.e[n2]] >>> n8 & 0xFF ^ n7;
                    int n13 = arrn2[n12] - 1;
                    arrn2[n12] = n13;
