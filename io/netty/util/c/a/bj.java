...
extends g {
    ...
    bj(g g2, int n2, int n3, int n4, av[] arrav, y y2, AtomicReference atomicReference) {
    ...
    public final void b() {
        ...
        if (y2 != null && (atomicReference = this.i) != null) {
            ...
            while (this.g > 0 && (n3 = (n2 = this.e) + n4 >>> 1) > n4) {
                ...
                this.b(1);
                this.e = n3;
                new bj(this, this.g >>>= 1, this.e, n2, this.a, y2, atomicReference).r();
            }
