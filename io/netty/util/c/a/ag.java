...
extends g {
    ...
    ag(g g2, int n2, int n3, int n4, av[] arrav, ag ag2, az az2, double d2, l l2) {
    ...
    public final void b() {
        ...
        if (az2 != null && (l2 = this.i) != null) {
            ...
            while (this.g > 0 && (n3 = (n2 = this.e) + n4 >>> 1) > n4) {
                this.b(1);
                this.e = n3;
                this.l = new ag(this, this.g >>>= 1, this.e, n2, this.a, this.l, az2, d2, l2);
                this.l.r();
            }
            while ((object = this.a()) != null) {
                d2 = l2.a(d2, az2.a(object));
            }
            this.k = d2;
