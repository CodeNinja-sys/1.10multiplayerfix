...
final class p {
    ...
    static void a(String string) {
        ...
        if (string.length() > 65535) {
            throw new IllegalArgumentException("name exceeds allowable length: " + string);
        }
        for (int i2 = 0; i2 < string.length(); ++i2) {
            char c2 = string.charAt(i2);
            if (c2 == '\u0000') {
                throw new IllegalArgumentException("name contains null character: " + string);
            }
            if (c2 <= '\u007f') continue;
    ...
    static void b(String string) {
        ...
        for (int i2 = 0; i2 < string.length(); ++i2) {
            char c2 = string.charAt(i2);
            if (c2 != '\u0000') continue;
            throw new IllegalArgumentException("value contains null character: " + string);
        }
    }
}
