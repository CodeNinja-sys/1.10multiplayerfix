...
extends ai {
    ...
    public am(String string, String string2, boolean bl2, int n2) {
        super(av.d, string, string2, n2);
        this.d = bl2;
    }
    ...
    protected w a(v v2, ar ar2) {
        ...
        if (a.d()) {
            a.b("WebSocket version 08 server handshake key: {}, response: {}", (Object)string, (Object)string3);
        }
    ...
    @Override
    protected ae f() {
        return new l(true, this.d, this.d());
    }
