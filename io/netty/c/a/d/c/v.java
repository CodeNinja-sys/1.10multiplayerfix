...
public class v
extends r {
    private static final g c = io.netty.util.c.b.h.a(v.class);
    public static final String b = "258EAFA5-E914-47DA-95CA-C5AB0DC85B11";
    private String d;
    private final boolean e;

    public v(URI uRI, av av2, String string, boolean bl2, ar ar2, int n2) {
        super(uRI, av2, string, ar2, n2);
        this.e = bl2;
    }

    @Override
    protected io.netty.c.a.d.v g() {
        URI uRI = this.a();
        ...
        this.d = au.c(arrby2);
        if (c.d()) {
            c.b("WebSocket version 08 client handshake key: {}, expected response: {}", (Object)string2, (Object)this.d);
        }
        h h2 = new h(br.b, aw.b, string);
        ar ar2 = h2.q();
        ar2.a("Upgrade", (Object)"WebSocket".toLowerCase()).a("Connection", (Object)"Upgrade").a("Sec-WebSocket-Key", (Object)string2).a("Host", (Object)uRI.getHost());
        int n2 = uRI.getPort();
        ...
        ar2.a("Sec-WebSocket-Version", (Object)"8");
        if (this.a != null) {
            ar2.a(this.a);
        }
        return h2;
    ...
    @Override
    protected ae h() {
        return new l(false, this.e, this.c());
    }
