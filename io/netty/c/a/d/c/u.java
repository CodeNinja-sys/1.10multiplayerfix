...
import io.netty.c.a.d.c.j;
import io.netty.c.a.d.c.k;
...
public class u
extends r {
    private static final g c = io.netty.util.c.b.h.a(u.class);
    public static final String b = "258EAFA5-E914-47DA-95CA-C5AB0DC85B11";
    private String d;
    private final boolean e;

    public u(URI uRI, av av2, String string, boolean bl2, ar ar2, int n2) {
    ...
    protected v g() {
        ...
        this.d = au.c(arrby2);
        if (c.d()) {
            c.b("WebSocket version 07 client handshake key: {}, expected response: {}", (Object)string2, (Object)this.d);
        }
        ...
        ar2.a("Sec-WebSocket-Version", (Object)"7");
        if (this.a != null) {
            ar2.a(this.a);
        }
        return h2;
    ...
    @Override
    protected ae h() {
        return new j(false, this.e, this.c());
    }
