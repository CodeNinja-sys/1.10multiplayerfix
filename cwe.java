...
public class cwe {
    ...
    public static String a(w w2, String string) {
        ...
        throw new ag("Expected " + string + " to be a string, was " + cwe.c(w2));
    }

    public static String f(z z2, String string) {
        if (z2.b(string)) {
            return cwe.a(z2.c(string), string);
        }
    ...
    public static azg b(w w2, String string) {
        if (w2.r()) {
            String string2 = w2.d();
            azg azg2 = azg.c(string2);
            if (azg2 == null) {
                throw new ag("Expected " + string + " to be an item, was unknown string '" + string2 + "'");
            }
            return azg2;
        }
        throw new ag("Expected " + string + " to be an item, was " + cwe.c(w2));
    }

    public static azg g(z z2, String string) {
        if (z2.b(string)) {
            return cwe.b(z2.c(string), string);
        }
    ...
    public static boolean c(w w2, String string) {
        ...
        throw new ag("Expected " + string + " to be a Boolean, was " + cwe.c(w2));
    }

    public static boolean h(z z2, String string) {
        if (z2.b(string)) {
            return cwe.c(z2.c(string), string);
        }
    ...
    public static float d(w w2, String string) {
        ...
        throw new ag("Expected " + string + " to be a Float, was " + cwe.c(w2));
    }

    public static float i(z z2, String string) {
        if (z2.b(string)) {
            return cwe.d(z2.c(string), string);
        }
    ...
    public static int e(w w2, String string) {
        ...
        throw new ag("Expected " + string + " to be a Int, was " + cwe.c(w2));
    }

    public static int j(z z2, String string) {
        if (z2.b(string)) {
            return cwe.e(z2.c(string), string);
        }
    ...
    public static z f(w w2, String string) {
        ...
        throw new ag("Expected " + string + " to be a JsonObject, was " + cwe.c(w2));
    }

    public static z k(z z2, String string) {
        if (z2.b(string)) {
            return cwe.f(z2.c(string), string);
        }
    ...
    public static t g(w w2, String string) {
        ...
        throw new ag("Expected " + string + " to be a JsonArray, was " + cwe.c(w2));
    }

    public static t l(z z2, String string) {
        if (z2.b(string)) {
            return cwe.g(z2.c(string), string);
        }
    ...
    public static Object a(z z2, String string, u u2, Class class_) {
        if (z2.b(string)) {
            return cwe.a(z2.c(string), string, u2, class_);
        }
        throw new ag("Missing " + string);
    }
    ...
    public static Object a(k k2, String string, Class class_) {
        return cwe.a(k2, string, class_, false);
    }

    public static Object a(k k2, String string, Class class_, boolean bl2) {
        return cwe.a(k2, new StringReader(string), class_, bl2);
    }
}
