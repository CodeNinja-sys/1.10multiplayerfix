...
extends agg {
    ...
    private final FloatBuffer f = avj.e(16);
    private final FloatBuffer g = avj.e(16);
    private final FloatBuffer h = avj.e(16);
    ...
    private void a(float[] arrf) {
        float f2 = cmk.c(arrf[0] * arrf[0] + arrf[1] * arrf[1] + arrf[2] * arrf[2]);
        arrf[0] = arrf[0] / f2;
        arrf[1] = arrf[1] / f2;
        arrf[2] = arrf[2] / f2;
        arrf[3] = arrf[3] / f2;
