...
public enum e {
    ...
    public static e a(int n2) {
        for (e e2 : net.minecraft.client.b.e.values()) {
            if (e2.c() != n2) continue;
            return e2;
        }
        return null;
     ...
     * WARNING - void declaration
     */
    private e(boolean bl2, float f2, float f3, float f4) {
        void var8_6;
        void var7_5;
        this.P = (String)bl2;
        this.N = f2;
    ...
    public float b(float f2) {
        return net.minecraft.u.b.n.a((this.d(f2) - this.R) / (this.S - this.R), 0.0f, 1.0f);
    }

    public float c(float f2) {
        return this.d(this.R + (this.S - this.R) * net.minecraft.u.b.n.a(f2, 0.0f, 1.0f));
    }

    public float d(float f2) {
        f2 = this.e(f2);
        return net.minecraft.u.b.n.a(f2, this.R, this.S);
    }
    ...
    static /* synthetic */ float a(e e2) {
        return e2.S;
    }

    static /* synthetic */ float b(e e2) {
        return e2.R;
    }
}
