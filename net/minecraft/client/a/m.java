...
public class m
extends cb {
    private static final bp a = new bp("textures/entity/explosion.png");
    ...
    protected m(c c2, k k2, double d2, double d3, double d4, double d5, double d6, double d7) {
        super(k2, d2, d3, d4, 0.0, 0.0, 0.0);
        float f2;
        this.N = c2;
        this.M = 6 + this.r.nextInt(4);
    ...
    public void a(g g2, n n2, float f2, float f3, float f4, float f5, float f6, float f7) {
        int n3 = (int)(((float)this.L + f2) * 15.0f / (float)this.M);
        if (n3 <= 15) {
            this.N.a(a);
            float f8 = (float)(n3 % 4) / 4.0f;
            float f9 = f8 + 0.24975f;
            float f10 = (float)(n3 / 4) / 4.0f;
            ...
            am.a();
            g2.a(7, b);
            g2.b((double)(f13 - f3 * f12 - f6 * f12), (double)(f14 - f4 * f12), (double)(f15 - f5 * f12 - f7 * f12)).a(f9, f11).a(this.A, this.B, this.C, 1.0f).a(0, 240).c(0.0f, 1.0f, 0.0f).d();
            g2.b((double)(f13 - f3 * f12 + f6 * f12), (double)(f14 + f4 * f12), (double)(f15 - f5 * f12 + f7 * f12)).a(f9, f10).a(this.A, this.B, this.C, 1.0f).a(0, 240).c(0.0f, 1.0f, 0.0f).d();
            g2.b((double)(f13 + f3 * f12 + f6 * f12), (double)(f14 + f4 * f12), (double)(f15 + f5 * f12 + f7 * f12)).a(f8, f10).a(this.A, this.B, this.C, 1.0f).a(0, 240).c(0.0f, 1.0f, 0.0f).d();
            g2.b((double)(f13 + f3 * f12 - f6 * f12), (double)(f14 - f4 * f12), (double)(f15 + f5 * f12 - f7 * f12)).a(f8, f11).a(this.A, this.B, this.C, 1.0f).a(0, 240).c(0.0f, 1.0f, 0.0f).d();
            ci.a().b();
            bd.e();
        }
    }
