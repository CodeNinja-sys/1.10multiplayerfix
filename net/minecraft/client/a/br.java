...
extends cb {
    ...
    private br(k k2, double d2, double d3, double d4, double d5, double d6, double d7) {
        this(k2, d2, d3, d4, d5, d6, d7, 1.0f);
    }

    protected br(k k2, double d2, double d3, double d4, double d5, double d6, double d7, float f2) {
        ...
        this.k += d6;
        this.l += d7;
        this.A = f3 = (float)(Math.random() * (double)0.3f);
        this.B = f3;
        this.C = f3;
        this.y *= 0.75f;
        this.y *= f2;
    ...
    /* synthetic */ br(k k2, double d2, double d3, double d4, double d5, double d6, double d7, br br2) {
        this(k2, d2, d3, d4, d5, d6, d7);
    }
}
