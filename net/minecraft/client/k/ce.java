...
public class ce
implements j {
    private static final bp[] c = new bp[256];
    ...
    private final bp g;
    private final net.minecraft.client.g.a.c h;
    private float i;
    private float j;
    private boolean k;
    private boolean l;
    ...
    public ce(a a2, bp bp2, net.minecraft.client.g.a.c c2, boolean bl2) {
        this.g = bp2;
        this.h = c2;
        this.k = bl2;
        c2.a(this.g);
    ...
    private void c() {
        ...
        try {
            try {
                an2 = net.minecraft.client.r.z().O().a(this.g);
                bufferedImage = net.minecraft.client.g.a.p.a(an2.b());
            }
    ...
    private void d() {
        ...
        try {
            try {
                an2 = net.minecraft.client.r.z().O().a(new bp("font/glyph_sizes.bin"));
                an2.b().read(this.e);
            }
            catch (IOException iOException) {
                throw new RuntimeException(iOException);
    ...
    private float a(char c2, boolean bl2) {
        ...
        return n2 != -1 && !this.k ? this.a(n2, bl2) : this.b(c2, bl2);
    }
    ...
    private float a(int n2, boolean bl2) {
        ...
        bd.o(5);
        bd.b((float)n3 / 128.0f, (float)n4 / 128.0f);
        bd.e(this.i + (float)bl3, this.j, 0.0f);
        bd.b((float)n3 / 128.0f, ((float)n4 + 7.99f) / 128.0f);
        bd.e(this.i - (float)bl3, this.j + 7.99f, 0.0f);
        bd.b(((float)n3 + f2 - 1.0f) / 128.0f, (float)n4 / 128.0f);
        bd.e(this.i + f2 - 1.0f + (float)bl3, this.j, 0.0f);
        bd.b(((float)n3 + f2 - 1.0f) / 128.0f, ((float)n4 + 7.99f) / 128.0f);
        bd.e(this.i + f2 - 1.0f - (float)bl3, this.j + 7.99f, 0.0f);
        bd.G();
        return n5;
    }
    ...
    private bp a(int n2) {
        if (c[n2] == null) {
            ce.c[n2] = new bp(String.format("textures/font/unicode_page_%02x.png", n2));
        }
        return c[n2];
    }
    ...
    private float b(char c2, boolean bl2) {
        ...
        bd.o(5);
        bd.b(f4 / 256.0f, f5 / 256.0f);
        bd.e(this.i + f7, this.j, 0.0f);
        bd.b(f4 / 256.0f, (f5 + 15.98f) / 256.0f);
        bd.e(this.i - f7, this.j + 7.99f, 0.0f);
        bd.b((f4 + f6) / 256.0f, f5 / 256.0f);
        bd.e(this.i + f6 / 2.0f + f7, this.j, 0.0f);
        bd.b((f4 + f6) / 256.0f, (f5 + 15.98f) / 256.0f);
        bd.e(this.i + f6 / 2.0f - f7, this.j + 7.99f, 0.0f);
        bd.G();
        ...
        for (int i2 = 0; i2 < string.length(); ++i2) {
            ...
            if (c3 == '\u00a7' && i2 + 1 < string.length()) {
                ...
                if (n3 < 16) {
                    ...
                    this.q = n2 = this.f[n3];
                    bd.c((float)(n2 >> 16) / 255.0f, (float)(n2 >> 8 & 0xFF) / 255.0f, (float)(n2 & 0xFF) / 255.0f, this.p);
                } else if (n3 == 16) {
                    this.r = true;
                } else if (n3 == 17) {
                    this.s = true;
                    ...
                    this.u = false;
                    this.t = false;
                    bd.c(this.m, this.n, this.o, this.p);
                }
                ++i2;
                continue;
            }
            ...
            if (this.v) {
                ...
                g2.b((double)this.i, (double)(this.j + (float)(this.a / 2)), 0.0).d();
                g2.b((double)(this.i + f3), (double)(this.j + (float)(this.a / 2)), 0.0).d();
                g2.b((double)(this.i + f3), (double)(this.j + (float)(this.a / 2) - 1.0f), 0.0).d();
                g2.b((double)this.i, (double)(this.j + (float)(this.a / 2) - 1.0f), 0.0).d();
                ci2.b();
                bd.v();
            }
            if (this.u) {
                ...
                g2.a(7, net.minecraft.client.g.d.b.e);
                int n4 = this.u ? -1 : 0;
                g2.b((double)(this.i + (float)n4), (double)(this.j + (float)this.a), 0.0).d();
                g2.b((double)(this.i + f3), (double)(this.j + (float)this.a), 0.0).d();
                g2.b((double)(this.i + f3), (double)(this.j + (float)this.a - 1.0f), 0.0).d();
                g2.b((double)(this.i + (float)n4), (double)(this.j + (float)this.a - 1.0f), 0.0).d();
                ci2.b();
                bd.v();
            }
            this.i += (float)((int)f3);
    ...
    private void a(String string, int n2, int n3, int n4, boolean bl2) {
        for (String string2 : this.c(string, n4)) {
    ...
    String d(String string, int n2) {
        ...
        boolean bl2 = c2 == ' ' || c2 == '\n';
        String string3 = String.valueOf(ce.b(string2)) + string.substring(n3 + (bl2 ? 1 : 0));
    ...
    public int b(char c2) {
        ...
        return n2 >= 0 && n2 < this.f.length ? this.f[n2] : -1;
    }
}
