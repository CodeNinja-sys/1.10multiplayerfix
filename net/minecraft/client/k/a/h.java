...
import net.minecraft.client.k.a.k;
...
extends i {
    ...
    public h(j j2, r r2) {
        ...
        super(j2, r2);
        this.w = ov.a();
        for (c c2 : net.minecraft.r.o.e) {
            boolean bl2 = false;
            cg cg2 = c2.a();
            if (net.minecraft.client.k.a.j.a(j2).a(c2) > 0) {
                bl2 = true;
            } else if (net.minecraft.r.o.b(cg2) != null && net.minecraft.client.k.a.j.a(j2).a(net.minecraft.r.o.b(cg2)) > 0) {
                bl2 = true;
    ...
    protected void a(int n2, int n3, ci ci2) {
        super.a(n2, n3, ci2);
        if (this.b == 0) {
            net.minecraft.client.k.a.j.a(this.a, n2 + 115 - 18 + 1, n3 + 1 + 1, 18, 18);
        } else {
            net.minecraft.client.k.a.j.a(this.a, n2 + 115 - 18, n3 + 1, 18, 18);
        }
        if (this.b == 1) {
            net.minecraft.client.k.a.j.a(this.a, n2 + 165 - 18 + 1, n3 + 1 + 1, 36, 18);
        } else {
            net.minecraft.client.k.a.j.a(this.a, n2 + 165 - 18, n3 + 1, 36, 18);
        }
        if (this.b == 2) {
            net.minecraft.client.k.a.j.a(this.a, n2 + 215 - 18 + 1, n3 + 1 + 1, 54, 18);
        } else {
            net.minecraft.client.k.a.j.a(this.a, n2 + 215 - 18, n3 + 1, 54, 18);
        }
        if (this.b == 3) {
    ...
    protected void a(int n2, int n3, int n4, int n5, int n6, int n7) {
        ...
        this.a(net.minecraft.r.o.a(cg2), n3 + 115, n4, n2 % 2 == 0);
        this.a(net.minecraft.r.o.b(cg2), n3 + 165, n4, n2 % 2 == 0);
    ...
    protected String b(int n2) {
        return n2 == 0 ? "stat.crafted" : (n2 == 1 ? "stat.used" : (n2 == 3 ? "stat.pickup" : (n2 == 4 ? "stat.dropped" : "stat.mined")));
    }

    static /* synthetic */ j a(h h2) {
        return h2.a;
    }
}
