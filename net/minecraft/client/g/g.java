...
import net.minecraft.client.g.as;
...
public class g {
    ...
    private void b(int n2) {
        if (net.minecraft.u.b.n.c(n2, 4) / 4 > this.c.remaining() || this.f * this.n.g() + n2 > this.b.capacity()) {
            int n3 = this.b.capacity();
            int n4 = n3 + net.minecraft.u.b.n.c(n2, 0x200000);
            a.a("Needed to grow BufferBuilder buffer: Old size {} bytes, new size {} bytes.", n3, n4);
            int n5 = this.c.position();
            ByteBuffer byteBuffer = v.c(n4);
            this.b.position(0);
    ...
    public void a(float f2, float f3, float f4) {
        ...
        for (int i2 = 0; i2 < n2; ++i2) {
            arrf[i2] = net.minecraft.client.g.g.a(this.e, (float)((double)f2 + this.k), (float)((double)f3 + this.l), (float)((double)f4 + this.m), this.n.f(), i2 * this.n.g());
        }
        Integer[] arrinteger = new Integer[n2];
        for (int i3 = 0; i3 < arrinteger.length; ++i3) {
            arrinteger[i3] = i3;
        }
        Arrays.sort(arrinteger, new as(this, arrf));
    ...
    public at a() {
        ...
        this.c.position(n2);
        return new at(this, arrn, new f(this.n));
    }
    ...
    public void b(float f2, float f3, float f4, int n2) {
        int n3 = this.c(n2);
        int n4 = net.minecraft.u.b.n.a((int)(f2 * 255.0f), 0, 255);
        int n5 = net.minecraft.u.b.n.a((int)(f3 * 255.0f), 0, 255);
        int n6 = net.minecraft.u.b.n.a((int)(f4 * 255.0f), 0, 255);
    ...
    public g b(int n2, int n3, int n4, int n5) {
        if (this.i) {
            return this;
        }
    ...
    private void l() {
        ...
        if (this.g.b() == net.minecraft.client.g.d.g.g) {
            this.l();
        }
    }
