...
public class ao {
    ...
    public static String a(URL uRL, Map map, boolean bl2, Proxy proxy) {
        return ao.a(uRL, ao.a(map), bl2, proxy);
    }
    ...
    public static dl a(File file, String string, Map map, int n2, as as2, Proxy proxy) {
        dl dl2 = a.a(new ap(as2, string, proxy, map, file, n2));
        return dl2;
    }
