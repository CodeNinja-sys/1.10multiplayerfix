...
extends d {
    ...
    public by(int n2, Random random, dc dc2, ad ad2) {
        super(n2);
        this.a(ad2);
        this.b = dc2;
    ...
    public static by a(List list, Random random, int n2, int n3, int n4, ad ad2, int n5) {
        dc dc2 = dc.a(n2, n3, n4, -1, 0, 0, 5, 7, 5, ad2);
        return by.a(dc2) && r.a(list, dc2) == null ? new by(n5, random, dc2, ad2) : null;
    }
    ...
    public boolean a(k k2, Random random, dc dc2) {
        ...
        this.a(k2, dc2, 1, 2, 4, 4, 5, 4, p.by.v(), p.by.v(), false);
        this.a(k2, dc2, 1, 3, 4, 1, 4, 4, p.bz.v(), p.by.v(), false);
        this.a(k2, dc2, 3, 3, 4, 3, 4, 4, p.bz.v(), p.by.v(), false);
        if (this.a && dc2.a(new b(this.a(1, 3), this.a(2), this.b(1, 3)))) {
            this.a = false;
            this.a(k2, dc2, random, 1, 2, 3, j.g);
        }
