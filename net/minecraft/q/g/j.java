...
public class j
extends u {
    protected static final b a = p.k.v();
        ...
        while (n4 < n5) {
            ...
            if (n6 != 0 || random.nextInt(4) != 0) {
                ...
                if (d2 >= d6 - 16.0 - d8 * 2.0 && d4 >= d7 - 16.0 - d8 * 2.0 && d2 <= d6 + 16.0 + d8 * 2.0 && d4 <= d7 + 16.0 + d8 * 2.0) {
                    int n7;
                    int n8 = n.c(d2 - d8) - n2 * 16 - 1;
                    int n9 = n.c(d2 + d8) - n2 * 16 + 1;
                    int n10 = n.c(d3 - d9) - 1;
                    int n11 = n.c(d3 + d9) + 1;
                    int n12 = n.c(d4 - d8) - n3 * 16 - 1;
                        ...
                        for (n7 = n8; n7 < n9; ++n7) {
                            ...
                            for (int i5 = n12; i5 < n13; ++i5) {
                                ...
                                for (int i6 = n11; i6 > n10; --i6) {
                                    ...
                                    if (!((d14 * d14 + d15 * d15) * (double)this.c[i6 - 1] + d16 * d16 / 6.0 < 1.0)) continue;
                                    b b3 = e2.a(n7, i6, i5);
                                    if (b3.c() == p.c) {
                                        bl3 = true;
                                    }
                                    if (b3.c() != p.b && b3.c() != p.d && b3.c() != p.c) continue;
                                    if (i6 - 1 < 10) {
                                        e2.a(n7, i6, i5, a);
                                        continue;
                                    }
                                    e2.a(n7, i6, i5, b);
                                    if (!bl3 || e2.a(n7, i6 - 1, i5).c() != p.d) continue;
                                    g2.b(n7 + n2 * 16, 0, i5 + n3 * 16);
                                    e2.a(n7, i6 - 1, i5, this.g.a((net.minecraft.u.b.b)g2).u);
                                }
                            }
                        }
                        if (n6 != 0) break;
    ...
    protected void a(k k2, int n2, int n3, int n4, int n5, e e2) {
        if (this.f.nextInt(50) == 0) {
            ...
            double d3 = this.f.nextInt(this.f.nextInt(40) + 8) + 20;
            double d4 = n3 * 16 + this.f.nextInt(16);
            boolean bl2 = true;
            for (int i2 = 0; i2 < 1; ++i2) {
                float f2 = this.f.nextFloat() * ((float)Math.PI * 2);
                float f3 = (this.f.nextFloat() - 0.5f) * 2.0f / 8.0f;
                float f4 = (this.f.nextFloat() * 2.0f + this.f.nextFloat()) * 2.0f;
                this.a(this.f.nextLong(), n4, n5, e2, d2, d3, d4, f4, f2, f3, 0, 0, 3.0);
            }
        }
    }
}
