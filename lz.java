...
public enum lz {
    ...
    public static lz a(int n2) {
        return (lz)((Object)Z.get(n2));
    }

    public static lz a(String string) {
        return (lz)((Object)aa.get(string));
    }

    static {
        Z = sz.c();
        aa = sz.c();
        for (lz lz2 : lz.values()) {
            Z.put(lz2.c(), lz2);
            aa.put(lz2.b(), lz2);
        }
    }
