...
public class acq
extends cwc {
    public day a(w w2, Type type, u u2) {
        z z2 = w2.t();
        ...
        if (z2.b("characters")) {
            ...
            for (int i2 = 0; i2 < 256; ++i2) {
                ...
                float f7 = f4;
                if (w3 != null) {
                    z z5 = cwe.f(w3, "characters[" + i2 + "]");
                    f5 = cwe.a(z5, "width", f2);
                    ao.a(0.0, 3.4028234663852886E38, f5, "Invalid width");
                    f6 = cwe.a(z5, "spacing", f3);
        ...
        return new day(arrf, arrf3, arrf2);
    }
