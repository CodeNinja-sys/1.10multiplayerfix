...
extends axg {
    ...
    public void a(float f2, float f3, float f4, float f5, float f6, float f7, cpk cpk2) {
        ...
        this.j.g = -0.7853982f;
        this.k.g = 0.7853982f;
        float f11 = -(cmk.b(f2 * 0.6662f * 2.0f + 0.0f) * 0.4f) * f3;
        float f12 = -(cmk.b(f2 * 0.6662f * 2.0f + (float)Math.PI) * 0.4f) * f3;
        float f13 = -(cmk.b(f2 * 0.6662f * 2.0f + 1.5707964f) * 0.4f) * f3;
        float f14 = -(cmk.b(f2 * 0.6662f * 2.0f + 4.712389f) * 0.4f) * f3;
        float f15 = Math.abs(cmk.a(f2 * 0.6662f + 0.0f) * 0.4f) * f3;
        float f16 = Math.abs(cmk.a(f2 * 0.6662f + (float)Math.PI) * 0.4f) * f3;
        float f17 = Math.abs(cmk.a(f2 * 0.6662f + 1.5707964f) * 0.4f) * f3;
        float f18 = Math.abs(cmk.a(f2 * 0.6662f + 4.712389f) * 0.4f) * f3;
        this.d.g += f11;
        this.e.g += -f11;
        this.f.g += f12;
        this.g.g += -f12;
