...
extends ayy {
    ...
    public ayz(bjs bjs2, bxy bxy2) {
        ...
        for (va va2 : bpv.d) {
            ...
            if (bjs.b(bjs2).a(va2) > 0) {
                bl2 = true;
            } else if (bpv.c(azg2) != null && bjs.b(bjs2).a(bpv.c(azg2)) > 0) {
                bl2 = true;
    ...
    protected void a(int n2, int n3, bha bha2) {
        super.a(n2, n3, bha2);
        if (this.a == 0) {
            bjs.a(this.A, n2 + 115 - 18 + 1, n3 + 1 + 1, 72, 18);
        } else {
            bjs.a(this.A, n2 + 115 - 18, n3 + 1, 72, 18);
        }
        if (this.a == 1) {
            bjs.a(this.A, n2 + 165 - 18 + 1, n3 + 1 + 1, 18, 18);
        } else {
            bjs.a(this.A, n2 + 165 - 18, n3 + 1, 18, 18);
        }
        if (this.a == 2) {
            bjs.a(this.A, n2 + 215 - 18 + 1, n3 + 1 + 1, 36, 18);
        } else {
            bjs.a(this.A, n2 + 215 - 18, n3 + 1, 36, 18);
        }
        if (this.a == 3) {
    ...
    protected void a(int n2, int n3, int n4, int n5, int n6, int n7) {
        ...
        this.a(bpv.c(azg2), n3 + 115, n4, n2 % 2 == 0);
        this.a(bpv.a(azg2), n3 + 165, n4, n2 % 2 == 0);
